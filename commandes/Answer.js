...
zokou({
  ...
  try {
    if (!args || args.length === 0) {
      return respond("Usage example: .pair 255792372250.");
    }
...
zokou({
  ...
  try {
    if (!_0xea7c04 || _0xea7c04.length === 0x0) {
      return _0x5e569a("Hello am *VAR KITA.* an AI developed by Mr street.\n\n What help can I offer you today?");
    }
